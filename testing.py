...
# # Load the XGBoost model from the .pkl file (do this once, not inside the function)
# model2 = joblib.load("PM25Model.pkl")
...
#     input_df = pd.DataFrame([[input_features[col] for col in FEATURE_ORDER_PM25]], columns=FEATURE_ORDER_PM25)

#     prediction = model2.predict(input_df)
#     return round(prediction[0])

# res = predict_pm25(30.0, 22.31925815997473, 73.21655888438862)
# print(res)
...
PM10_pred = predict_pm10(PM10, lat, lon)
NO2_pred = predict_NO2(NO2, lat, lon)
SO2_pred = predict_SO2(SO2, lat, lon)
O3_pred = predict_O3(O3, lat, lon)

print("PM2.5 Prediction:", PM25_pred)
print("PM10 Prediction:", PM10_pred)
print("NO2 Prediction:", NO2_pred)
print("SO2 Prediction:", SO2_pred)
print("O3 Prediction:", O3_pred)
